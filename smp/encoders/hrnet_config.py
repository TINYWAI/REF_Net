...
HRNET_48.out_channels = [
    3,
    64,
    HRNET_48.STAGE1.NUM_CHANNELS,
    HRNET_48.STAGE2.NUM_CHANNELS,
    HRNET_48.STAGE3.NUM_CHANNELS,
    HRNET_48.STAGE4.NUM_CHANNELS,
]
...
HRNET_32.out_channels = [
    3,
    64,
    HRNET_32.STAGE1.NUM_CHANNELS,
    HRNET_32.STAGE2.NUM_CHANNELS,
    HRNET_32.STAGE3.NUM_CHANNELS,
    HRNET_32.STAGE4.NUM_CHANNELS,
]
...
MODEL_CONFIGS = {
    'hrnet': {
        ...
        'out_channels': [
            ...
            HRNET_18.STAGE2.NUM_CHANNELS,
            HRNET_18.STAGE3.NUM_CHANNELS,
            HRNET_18.STAGE4.NUM_CHANNELS,
        ]
    },
    'hrnet32': {
        'cfg': HRNET_32,
